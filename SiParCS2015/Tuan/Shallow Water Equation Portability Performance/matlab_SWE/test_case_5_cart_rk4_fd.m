...
% the mean offset gh0.
H = [uc gh];   % concantenate uc and gh horizontally


% Compute the projected gradient of the mountain for test case 5
gradghm = zeros(atm.pts.nd,3);      % Initialize 2-D matrix gradghm: atm.pts.nd x 3
...
% write output from here
% H, DPx, DPy, DPz, L, ATM, gradghm
