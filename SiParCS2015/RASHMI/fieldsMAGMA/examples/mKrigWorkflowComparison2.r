...
#using the CO2 dataset from fields.  Accelerated using 2 GPUs. Uses chordal distances.
...
accelTime = system.time(workflow(x, y, 2))[3]
...
#save data:
save(list=c("n", "time", "accelTime", "lim"), file=paste0(thisDir, "/mKrigWorkflowComparison2_n", n, ".RData"))
